...
| export.page_toc                       | Whether to expand Table of Contents (TOC) macro at the top of the page.                                               | True                                                                |
| export.page_metadata_in_frontmatter   | Whether to add Confluence page original url, version, last edited date and editor name to the page as front matter.   | False                                                               |
| export.page_always_expand             | Whether to remove expand-container block and show as normal content.                                                  | False                                                               |
